-- Drop all versions of get_user_automation_preferences function forcefully
DROP FUNCTION IF EXISTS public.get_user_automation_preferences() CASCADE;
DROP FUNCTION IF EXISTS public.get_user_automation_preferences(uuid) CASCADE;
