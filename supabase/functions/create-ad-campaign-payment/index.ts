...
serve(async (req) => {
  console.log('Ad campaign payment function called');
  ...
  try {
    ...
    console.log('Processing payment for campaign:', campaignId, 'Amount:', totalAmount);
    ...
    // Update campaign with payment session ID
    ...
    console.log('Campaign updated successfully with session ID:', session.id);
