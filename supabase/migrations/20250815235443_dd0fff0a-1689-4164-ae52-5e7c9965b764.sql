...
-- Create a function for getting business contact info (only for authenticated users)
...
-- Create updated public business info function (excludes sensitive contact data)
...
GRANT EXECUTE ON FUNCTION get_public_business_info(uuid) TO authenticated, anon;