...
BEGIN
  ...
  LOOP
    EXECUTE format('DROP POLICY IF EXISTS %I ON public.safety_alerts', pol.polname);
  END LOOP;
END $$;
...
-- The function already exists in this project (see metadata). We just make sure proper execute permissions are set.
