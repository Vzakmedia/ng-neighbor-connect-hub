-- Add location filtering enums and columns to community posts
CREATE TYPE location_scope AS ENUM ('neighborhood', 'city', 'state', 'all');

-- Add location columns to community_posts
ALTER TABLE public.community_posts 
ADD COLUMN location_scope location_scope DEFAULT 'all',
...
CREATE INDEX idx_community_posts_location ON public.community_posts(location_scope, target_state, target_city, target_neighborhood) WHERE location_scope != 'all';

-- Function to get location-filtered posts
