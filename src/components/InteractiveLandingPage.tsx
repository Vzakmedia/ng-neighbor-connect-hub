...
const InteractiveLandingPage = () => {
  ...
  const liveStats = [
    { number: "50,247", label: "Active Users", icon: Users, increment: 3 },
    { number: "1,238", label: "Communities", icon: MapPin, increment: 1 },
    { number: "24/7", label: "Support", icon: Clock, increment: 0 },
    { number: "99.9%", label: "Uptime", icon: Award, increment: 0 }
  ];
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <motion.div
        className="fixed w-6 h-6 border-2 border-primary/30 rounded-full pointer-events-none z-50 mix-blend-difference"
        animate={{
      ...
      <section className="relative overflow-hidden py-24 lg:py-32">
        <motion.div style={{ y: y1 }} className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-primary/5" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <motion.div
                  className="absolute top-4 right-4 bg-white/90 backdrop-blur rounded-full p-3 shadow-lg"
                  animate={{ y: [-5, 5, -5] }}
                ...
                <motion.div
                  className="absolute bottom-4 left-4 bg-white/90 backdrop-blur rounded-full p-3 shadow-lg"
                  animate={{ y: [5, -5, 5] }}
            ...
            >
              <Card className={`p-8 ${features[activeFeature].bgColor} border-0 shadow-xl`}>
                <CardContent className="space-y-6 p-0">
                  ...
                  <motion.div
                    className="w-full bg-white/50 rounded-full h-2 overflow-hidden"
                  >
                    <motion.div
                ...
                return (
                  ...
                  >
                    <Card className={`p-6 text-center space-y-3 ${
                      index === activeFeature ? feature.bgColor + ' border-primary/50' : 'hover:shadow-lg'
                    }`}>
                      <motion.div
                        className={`w-12 h-12 rounded-lg bg-gradient-to-br ${feature.color} flex items-center justify-center mx-auto`}
                        animate={{ 
      ...
      <section className="py-24 bg-muted/30">
        <div className="container px-4 mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Smartphone, title: "Mobile App", desc: "Native iOS and Android apps with full feature access" },
              { icon: Monitor, title: "Web Platform", desc: "Full-featured web application accessible from any browser" },
              { icon: Tablet, title: "Tablet Optimized", desc: "Responsive design optimized for tablet interactions" }
            ].map((device, index) => {
      ...
      <section id="contact" className="py-24">
        <div className="container px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Mail, title: "Email Support", info: "support@neighborlink.ng", detail: "Response within 24 hours" },
              { icon: Phone, title: "Phone Support", info: "+234 (0) 800-NEIGHBOR", detail: "Mon-Fri, 9AM-6PM WAT" },
              { icon: Globe, title: "Online Help", info: "help.neighborlink.ng", detail: "24/7 self-service support" }
            ].map((contact, index) => {
