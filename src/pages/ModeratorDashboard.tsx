...
import { Shield, Users, MessageSquare, Flag, AlertTriangle, Eye, CheckCircle, XCircle, Clock, Search, ArrowLeft, Grid, RefreshCw, Home } from '@/lib/icons';
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-foreground">Moderator Dashboard</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-emerald-600 bg-clip-text text-transparent inline-block">Moderator Dashboard</h1>
            <p className="text-muted-foreground text-sm mt-1">Content moderation and community safety management</p>
          </div>
        </div>
