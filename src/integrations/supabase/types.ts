  ...
  public: {
    ...
    Functions: {
      ...
      create_conversation_with_request_check:
        | {
            Args: {
              ...
              _marketplace_item_id?: string
              _marketplace_service_id?: string
      ...
      create_staff_invitation:
        ...
        | {
            Args: { invitation_email: string; invitation_role: string }
            Returns: {
              email: string
              expires_at: string
              id: string
      ...
      delete_messages: { Args: { message_ids: string[] }; Returns: boolean }
      ...
      generate_board_invite_code: { Args: never; Returns: string }
      ...
      get_cached_alerts: { Args: { _cache_key: string }; Returns: Json }
      get_comment_likes: {
      ...
      get_flagged_content_count: { Args: never; Returns: number }
      ...
      get_sponsored_content_count: { Args: never; Returns: number }
      ...
      get_unread_board_posts_count: { Args: never; Returns: number }
      ...
      mark_all_community_posts_as_read: { Args: never; Returns: undefined }
      ...
      process_alert_queue: { Args: never; Returns: undefined }
